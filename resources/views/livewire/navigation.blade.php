<nav class="bg-gray-800" x-data="{ open:false}">
    <div class="max-w-7xl mx-auto px-2 sm:px-6 lg:px-8">
      <div class="relative flex items-center justify-between h-16">
        ...
        <div class="flex-1 flex items-center justify-center sm:justify-start">
            ...
            {{-- logotipo   sm:items-stretch (la quite) --}}
            <a href="/" class="flex-shrink-0 flex items-center">
                <img class="block lg:hidden h-16 w-14" src="/storage/logos/hdep_logo_sinL.png" alt="Workflow">
                <img class="hidden lg:block h-32 w-28" src="/storage/logos/hdep_logo_h.png" alt="Workflow">
            </a>
            ...
            <div class="hidden sm:block sm:ml-6">
                <div class="flex space-x-4">
                    ...
                    <a href="/" class="bg-gray-900 text-white px-3 py-2 rounded-md text-sm font-medium">Módulos</a>
    ...
    {{--Menu mobil--}}
    <div x-on:click.away="open = false" class="sm:hidden" x-show="open">
