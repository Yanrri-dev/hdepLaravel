<x-app-layout>
    ...
    <div class="container w-full md:w-4/5 xl:w-3/5  mx-auto px-2 py-4">
        ...
        <div class="card">
            <div class="card-body">
                {!! Form::model($pregunta,['route' => ['preguntas.update', [$modulo,$evaluation,$pregunta]], 'method' => 'put']) !!}
                    ...
                    <div class="form-group">
                        ...
                        {!! Form::number('number', null, ['class' => 'form-control', 'min' => '1' ,'step' => '1']) !!}
                    ...
                    <div class="form-group">
                        ...
                        {!! Form::number('total_score', null, ['class' => 'form-control', 'min' => '0.1' , 'step' => '0.1']) !!}
                        @error('total_score')
                            <span class="text-danger">{{$message}}</span>
                        @enderror
                    </div>   
