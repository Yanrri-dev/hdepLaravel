<x-app-layout>
    ...
    <div class="container w-full md:w-4/5  mx-auto px-2 py-4">
        <h1 class="text-4xl font-bold text-gray-500 py-5 mb-4">           
            Preguntas de <a href="{{route('evaluations.index',$modulo)}}">{{$evaluation->name}}</a>
        </h1>
        ...
        <div id='recipients' class="p-8 mt-6 lg:mt-0 rounded shadow bg-white">
            ...
            <div id='recipients' class="p-2 mt-6 mb-6 lg:mt-0 rounded bg-white">
                <a class="p-2 my-2 bg-blue-500 text-white rounded-md focus:outline-none focus:ring-2 ring-blue-300 ring-offset-2" href="{{route('preguntas.create',[$modulo,$evaluation])}}">Agregar Pregunta</a>
            </div>
            ...
            <table class="stripe hover" id="example" style="width:100%; padding-top: 1em;  padding-bottom: 1em; text-align: center;">
                ...
                <tbody>
                    @foreach ($preguntas as $pregunta)
                        <tr>
                            <td>{{$pregunta->name}}</td>
                            <td>{{$pregunta->number}}</td>
                            <td>{{$pregunta->total_score}}</td>

                            <td width="10px">
                                <a class="tooltip p-2 my-2 bg-gray-300 text-gray-800 rounded-md focus:outline-none focus:ring-2 ring-yellow-300 ring-offset-2" href="{{route('criterios.index',[$modulo,$evaluation,$pregunta])}}">Criterios<span class="tooltiptext">Ver Criterios</span></a>
                            </td>
